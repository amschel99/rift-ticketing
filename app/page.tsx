...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8 bg-white">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <div className="rounded-lg border border-[#E9F1F4] bg-[#F8F9FA] p-6 hover:border-[#2E8C96] transition-colors">
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8 bg-[#E9F1F4]">
        <div className="mx-auto max-w-7xl">
          ...
          {isLoading ? (
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="rounded-lg border border-[#E9F1F4] h-64 bg-white animate-pulse" />
              ))}
            </div>
          ) : events.length > 0 ? (
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="text-center py-12">
              <p className="text-[#4A5568]">No events available yet</p>
            </div>
          )}
        </div>
      </section>
